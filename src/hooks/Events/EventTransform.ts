...
import { ICXR, ICXREvent } from "../../server/icxr";

export const ICXREventTransformer = new PayloadModelTransformer(
  ICXR.events,
  "events",
  (e) => {
    let t: Partial<Event> = {
...
export const EventBeforeChangeHook = ICXREventTransformer.createBeforeChangeHook();
export const EventAfterDeleteHook = ICXREventTransformer.createAfterDeleteHook();
